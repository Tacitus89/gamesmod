...
class install_2_0_3 extends \phpbb\db\migration\migration
{
	var $games_version = '2.0.3';
	...
	{
		return array('\tacitus89\gamesmod\migrations\install_2_0_2');
	}
	...
	public function update_data()
	{
		return array(
			...
			array('config.add', array('game_display_profile', 1)),
			array('config.add', array('game_profile_sep', 1)),
		);
	}
