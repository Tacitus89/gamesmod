...
// Games Management
	...
	'ACP_GAME_DELETE_GOOD'				=> 'The game was removed successfully.<br /><br /> Click <a href="%s">here</a> to return to the previous category',
	'ACP_GAME_EDIT_GOOD'				=> 'The game was updated successfully.<br /><br /> Click <a href="%s">here</a> to go the game\'s category',
	'ACP_GAME_ADD_GOOD'					=> 'The game was added successfully.<br /><br /> Click <a href="%s">here</a> to go the game\'s category',
	'ACP_CONFIRM_MSG_1'					=> 'Are you sure you wish to delete this game? This will also delete this game from any users that have it. <br /><br /><form method="post"><fieldset class="submit-buttons"><input class="button1" type="submit" name="confirm" value="Yes" />&nbsp;<input type="submit" class="button2" name="cancelgame" value="No" /></fieldset></form>',
	...
	'ACP_CAT_DELETE_MOVE_GOOD'			=> 'All games from "%1$s" have been moved to "%2$s" and the category has been deleted successfully.<br /><br /> Click <a href="%3$s">here</a> to return the categories list page',
...
// Games Configuration
	...
	'ACP_GAMES_CONF_SAVED'				=> 'Games configuration saved<br /><br /> Click <a href="%s">here</a> to go the Game\'s ACP Configuration',
