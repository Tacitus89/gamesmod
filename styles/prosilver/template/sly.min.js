...
$(function() {
    $('.games').each(function() {
    	...
    	var $option = {
    		...
    		touchDragging: 1,
    		startAt: 0,
    		scrollBar: $wrap.find('.game_scrollbar'),
    		scrollBy: 1,
    		pagesBar: $wrap.find('.game_navpages'),
        ...
        function needSly()
        {
            ...
            {
                $wrap.find('.game_scrollbar').hide();
                $wrap.find('.game_navpages').hide();
                $slidee.css("margin", "0 auto");
            }
            else
            {
                $wrap.find('.game_scrollbar').show();
                $wrap.find('.game_navpages').show();
                $slidee.css("margin", "0");
            }
        }

        $(window).on("resize",function(){$sly.reload();needSly();});
